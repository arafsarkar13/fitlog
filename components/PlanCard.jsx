...
export default function PlanCard({ workout, onRemove }) {
  const { id, name, image, equipment, duration, caloriesBurned, rating } =
    workout;

  return (
    <div className="border-line bg-card flex flex-col gap-4 rounded-xl border p-4 sm:flex-row sm:items-center">
      {/* Thumbnail */}
